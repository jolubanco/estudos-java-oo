...
public class AutenticacaoViaTokenFilter extends OncePerRequestFilter {
    ...
    //classe de filtro não podem injetar dependências por isso precisamos do construtor
    ...
    private void autenticarCliente(String token) {
        ...
        SecurityContextHolder.getContext().setAuthentication(autentication); //força a autenticação
    }
